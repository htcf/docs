...
| Access from | All HTCF Nodes | All HTCF Nodes (read/write) | All HTCF Nodes (read-only on compute nodes) | All HTCF Nodes (read/write) | All HTCF Nodes (read/write) |
